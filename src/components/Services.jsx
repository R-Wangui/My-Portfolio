...
//           className='dev'>
//             <Card.Body>
//             <svg xmlns="http://www.w3.org/2000/svg" width="44.28494" height="39.17435" viewBox="0 0 44.28494 39.17435" creator="Katerina Limpitsouni" className='codeIcon'>
...
//           className='design'>
//             <Card.Body>
//               <svg xmlns="http://www.w3.org/2000/svg" width="40.32232" height="46.88469" viewBox="0 0 40.32232 46.88469" creator="Katerina Limpitsouni" className='designIcon'>
        ...
        <div className="my-8 mx-8 grid grid-cols-1 lg:grid lg:grid-cols-2 gap-8 font-light text-gray-300 text-center items-center ">
          {skills.map((service, i) => (
            <div key={i} className="border rounded-xl p-4">
              <img
                className="bg-amber-500 self-center"
                src={service.icon}
                alt="Code or design icon"
              />
              <h5 className="mb-4 text-xl">{service.role}</h5>
              <ul>
                <li>{service.skill}</li>
              </ul>
            </div>
...
const skills = [
  ...
  },
  {
    ...
    role: "UI/UX Design",
    skill: "Prototyping, Usability study, ",
  }
];