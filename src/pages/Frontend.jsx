    ...
    <>
      ...
      <div className="relative min-h-screen bg-gradient-to-b from-gray-900 via-gray-950 to-black text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-20">
          ...
          >
            <h1 className="text-5xl font-bold mb-4 bg-gradient-to-r from-teal-400 via-cyan-400 to-blue-500 bg-clip-text text-transparent">
 ...
 const projects = [
   {
     ...
     desc: "A full-stack jewelry e-commerce platform built with Next.js, React Query, and Stripe. Features product management, cart state, and checkout flow.",
